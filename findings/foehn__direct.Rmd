...
png("C:/Users/tinos/Documents/Master - Climate Science/3 - Master Thesis/Defence/rq1_foehn_only_biglab.png", width = 1800, height =1800, res = 300)
...
plot(pred_nm1,
     ...
     ylab = "relative risk",
     col = "gold2",
     ci.arg = list(col = alpha(colour = "gold3", .15)),
     lwd = 2,
     cex.lab = 1.5,
     cex.axis = 1.5
     )
