...
kable(table_estimates,
      digits = 3,
      col.names = c("all-cause", "male", "female", "y64" ,"o64", "cvd", "resp", "inf", "uri", "ment"      ),
      align = rep("r", ncol(table_estimates) )) %>%
   kable_styling() %>%
