...
plot(pred_modif_new_sum,              ## cumulative exposure
  ...
  legend("left", ncol = 1, legend = c("temperature on foehn days", "temperature on non-foehn days"), col = c("green4", "gold2"),
         bty = "n", lwd=c(2,2), cex = 0.7)
...
# png("C:/Users/tinos/Documents/Master - Climate Science/3 - Master Thesis/plots/paper/pdf/rq3_subgroups_lolli_new.png", width = 1650, height =1900, res = 300)

# pdf("C:/Users/tinos/Documents/Master - Climate Science/3 - Master Thesis/plots/paper/pdf/figure_3_main_figure.pdf",
# width = 5.7, height =7)
...
graphics::layout(mat = layout_matrix,
       # widths = c(0.8, 0.2),  # Left column 40%, right column 60%
       # heights = c(0.5, 0.5)
...
plot(prednew,            
 ...
 text(24, 2 , labels = "(a)", pos = 4, cex = 1.5)
...
text(25, 2 , labels = "(b)", pos = 4, cex = 1.5)
...
for(i in 1:length(pred)) {
  ...
  # Draw the points
  points(pred[i], vertical_position, pch = 16, col = col, cex = 1.2)
}
...
legend("topright", ncol = 1,
       ...
       col = c("green4", "gold2"), bty = "n", lwd=c(3,3), cex = 1.5, ,y.intersp = 1.9)
...
data_oldfems_merged <- data_oldfems_merged |>
  mutate(
    ...
    # mal_o64 = rowSums(across(c(mal_a6574y, mal_a7584y, fem_a85plusy))),
    # mal_y64 = rowSums(across(c(mal_a014y, mal_a1564y))),
  )
