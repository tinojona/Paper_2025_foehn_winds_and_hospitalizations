...
png("C:/Users/tinos/Desktop/test3.png", width = 2500, height = 1500, res = 300)
par(mfrow = c(1,2),
  mar = c(3.5, 3.5, 1,1),
  mgp = c(2.1, 0.7, 0))
...
legend("topleft", ncol = 1, legend = c("before 2008", "after 2008"), col = c(colors[2], colors[3]),  bty = "n", lwd=c(2,2))
