...
# save table
write.csv(table_estimates, file = "data_nonsensitive/RQ1_table/rq1_table.csv")
...
for(i in 1:length(sizes)){
  ...
  # read data
  data_sens = read.csv(paste0("../data/Medstat_hospitalizations_aggregated/centroid_aggregated/hosp_buffer_", buffer, ".csv")) |>
    mutate(date = as.Date(date),
           stratum_dow = as.factor(stratum_dow),
           y64 = a014y + a1564y,
           o64 = a6574y + a7584y + a85plusy,
...
# save table
write.csv(sensitivity_table, file = "data_nonsensitive/RQ1_table/rq1_sensitivity_to_buffer_size.csv")
...
# save table
write.csv(table_estimates_transposed, "data_nonsensitive/RQ1_table/rq1_sensitivity_to_foehn_wind_aggregation_method.csv")
