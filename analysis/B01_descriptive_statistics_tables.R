...
# for Medstat table
station_MedStat = read.csv("data/Medstat_regions_per_buffer_size/MDSTID_MetRegions_8000_per_station.csv", header = TRUE)
...
# save the table
write.csv(subgroups, file = "output/tables/sTable3.csv")
