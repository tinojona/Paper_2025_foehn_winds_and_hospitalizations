...
png("figures/Figure3a.png", width = 1800, height = 1800, res = 300)
par(
  mar = c(3.5, 3.5, 1,1),
  mgp = c(2, 0.7, 0))
...
# save the plot
png("figures/Figure3b.png", width = 1350, height =1200, res = 300)
par(mfrow=c(1,1),
    mar = c(3,3,.5,.5),
    mgp = c(1.8, .5, 0))
...
# save figure
png("figures/sFigure6.png", width = 1800, height =1800, res = 300)
par(mfrow=c(3,3),
    mar = c(3,3,.5,.5),
    mgp = c(1.8, .5, 0))
...
# save table
write.csv(table_estimates, "data_nonsensitive/RQ2_table/sTable7_1998_2019.csv")
...
# save the plot
# png("figures/Figure3.png", width = 1650, height =1900, res = 300)
# pdf("figures/Figure3.pdf", width = 5.7, height =7)
...
# save the figure
png("figures/sFigure5.png", width = 1000, height =1000, res = 300)
par(mfrow=c(1,1),
    mar = c(3,3,.5,.5),
    mgp = c(1.8, .5, 0))
...
png("figures/sFigure7.png", width = 1800, height =1800, res = 300)
par(mfrow=c(3,3),
    mar = c(3,3,.5,.5),
    mgp = c(1.8, .5, 0))
...
png("figures/Model3_3D.png", width = 1800, height = 1800, res = 300)
par(
  mar = c(2, 3, 1,2),
  mgp = c(2.8, 2.5, 0))
...
data_ff = read.csv("../data/Medstat_hospitalizations_aggregated/hosp_buffer_8000sensitivity_onlyfullfoehnaggregation.csv") |>
...
# save table
write.csv(table_estimates_review, "data_nonsensitive/RQ2_table/sTable7.csv")
